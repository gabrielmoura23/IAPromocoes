...
namespace IAPromocoes.UI.MVC.Adm
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            .Include("~/assets/global/css/components-rounded.css")
            .Include("~/assets/global/css/plugins.css")
            .Include("~/assets/admin/layout3/css/layout.css")
            .Include("~/assets/admin/layout3/css/themes/default.css")
            .Include("~/assets/admin/layout3/css/custom.css");
