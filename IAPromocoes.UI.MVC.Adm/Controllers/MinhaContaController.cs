...
namespace IAPromocoes.UI.MVC.Adm.Controllers
{
    ...
    public class MinhaContaController : Controller
    {
        ...
        public MinhaContaController(ApplicationUserManager userManager)
        {
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            return new AccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "MinhaConta"), User.Identity.GetUserId());
        }
